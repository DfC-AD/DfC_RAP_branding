...
map1_static_map <- tm_shape(df_map_data,
  ...
  tm_add_legend("fill",
    fill = RColorBrewer::brewer.pal(3, "Purples"),
    border.col = "#454A58",
...
```{r map_interactive_1, echo = TRUE, warnings = FALSE, message = FALSE, fig.alt="Map of Northern Ireland shaded by percentage of under 25s living in each Local Government District. More detail on the trends are included in the text directly above or below the map", out.width="100%"}
...
```{r map_interactive_2, echo = TRUE, warnings = FALSE, message = FALSE, fig.alt="Map of Northern Ireland with points showing the location of benefits offices (JBO) and the number of available vacancies. More detail on the trends are included in the text directly above or below the map", out.width="100%"}
...
```{r alt_text_for_maps, echo = FALSE}
