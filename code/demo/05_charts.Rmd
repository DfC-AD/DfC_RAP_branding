...
fig5 <- plot_ly(df_mye_earliest_youthrate,
  ...
  layout( # add annotation
    ...
    shapes = list(vline(~ mean(earliest_youthrate), color = dfc_colour2)),
...
fig6 <- ggplot(
  ...
  scale_fill_manual(values = c(dfc_colour1, dfc_colour2)) +
...
fig7 <- plot_ly(df_mye_latest_5_agegroups,
  ...
  type = "bar",
  marker = list(color = c(
    dfc_colour1, dfc_colour2, dfc_colour3, dfc_colour4, dfc_colour5
  )),
...
fig8a <- plot_ly(df_mye_latest_over_under_65,
  ...
  marker = list(
    colors = c(dfc_colour1, dfc_colour2)
  ),
